...
func (p QRCode) Name() string    { return "qr" }
func (p QRCode) Alias() []string { return []string{"qrcode", "qr-code"} }
...
func (p QRCode) Flags() []Flag {
	return []Flag{
		{Name: "size", Short: "s", Desc: "QR code size hint", Value: uint(100), Type: FlagUint},
		{Name: "level", Short: "l", Desc: "Error correction level (L/M/H)", Value: "H", Type: FlagString},
...
func (p QRCode) FilterValue() string { return p.Title() }
