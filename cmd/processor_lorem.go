...
var lorem_flag_p uint

func init() {	
	loremCmd.Flags().UintVarP(&lorem_flag_p, "paragraphs", "p", 1, "Number of paragraphs")
...
var loremCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		p := processors.Lorem{}
		flags = append(flags, processors.Flag{Short: "p", Value: lorem_flag_p})
