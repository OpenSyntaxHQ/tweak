...
var (	
	jwtEncode_flag_s string	
	jwtEncode_flag_e uint
)
...
var jwtEncodeCmd = &cobra.Command{
	Use:     "jwt-encode [string]",
	Short:   "Encode and sign JWT (HS256)",
	Aliases: []string{"jwt-e", "jwt-sign"},
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		p := processors.JWTEncode{}
		flags = append(flags, processors.Flag{Short: "s", Value: jwtEncode_flag_s})
		flags = append(flags, processors.Flag{Short: "e", Value: jwtEncode_flag_e})
