...
var aesEncryptCmd = &cobra.Command{
	Use:     "aes-encrypt [string]",
	Short:   "AES-256-GCM encrypt",
	Aliases: []string{"aes-enc", "encrypt"},
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		p := processors.AESEncrypt{}
		flags = append(flags, processors.Flag{Short: "k", Value: aesEncrypt_flag_k})
