...
func init() {
	rootCmd.AddCommand(validateUrlCmd)
}

var validateUrlCmd = &cobra.Command{
	Use:     "validate-url [string]",
	Short:   "Check if input is a valid URL",
	Aliases: []string{"is-url"},
