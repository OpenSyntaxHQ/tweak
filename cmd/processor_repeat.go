...
var repeat_flag_c uint

func init() {	
	repeatCmd.Flags().UintVarP(&repeat_flag_c, "count", "c", 2, "Number of repetitions")
...
var repeatCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		p := processors.Repeat{}
		flags = append(flags, processors.Flag{Short: "c", Value: repeat_flag_c})
