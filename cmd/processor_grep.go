...
var grepCmd = &cobra.Command{
	Use:     "grep [string]",
	Short:   "Filter lines matching a pattern",
	Aliases: []string{"filter", "filter-lines"},
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		p := processors.Grep{}
		flags = append(flags, processors.Flag{Short: "p", Value: grep_flag_p})
		flags = append(flags, processors.Flag{Short: "v", Value: grep_flag_v})
