...
func init() {
	rootCmd.AddCommand(base62DecodeCmd)
}

var base62DecodeCmd = &cobra.Command{
	Use:     "base62-decode [string]",
	Short:   "Decode your Base62 text",
	Aliases: []string{"b62-dec", "b62-decode"},
