...
func init() {
	rootCmd.AddCommand(binaryDecodeCmd)
}

var binaryDecodeCmd = &cobra.Command{
	Use:     "binary-decode [string]",
	Short:   "Decode binary representation to text",
	Aliases: []string{"bin-dec"},
