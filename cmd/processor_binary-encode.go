...
func init() {
	rootCmd.AddCommand(binaryEncodeCmd)
}

var binaryEncodeCmd = &cobra.Command{
	Use:     "binary-encode [string]",
	Short:   "Encode your text to binary representation",
	Aliases: []string{"bin-enc"},
