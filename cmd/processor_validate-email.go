...
func init() {
	rootCmd.AddCommand(validateEmailCmd)
}

var validateEmailCmd = &cobra.Command{
	Use:     "validate-email [string]",
	Short:   "Check if input is a valid email address",
	Aliases: []string{"is-email"},
