...
func init() {
	rootCmd.AddCommand(jsonlJsonCmd)
}

var jsonlJsonCmd = &cobra.Command{
	Use:     "jsonl-json [string]",
	Short:   "Convert JSONL/NDJSON to JSON array",
	Aliases: []string{"ndjson-json", "jsonl-to-json"},
