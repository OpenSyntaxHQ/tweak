...
func init() {	
	zeropadCmd.Flags().UintVarP(&zeropad_flag_n, "number-of-zeros", "n", 5, "Number of zeros to pad")
	zeropadCmd.Flags().StringVarP(&zeropad_flag_p, "prefix", "p", "", "Prefix before the number")
